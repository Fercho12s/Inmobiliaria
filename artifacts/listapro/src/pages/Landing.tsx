    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="relative z-10 w-full px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center pt-20">
          ...
          >
            ...
            <p className="text-sm md:text-lg text-muted-foreground uppercase tracking-[0.4em] mb-12">
              UN NUEVO ESTÁNDAR EN MARKETING INMOBILIARIO
            </p>
      ...
      <section className="py-32 bg-background relative border-t border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-20">
            <h2 className="text-sm font-semibold uppercase tracking-[0.3em] text-white mb-6">Nuestros Servicios</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-16">
            {[
              ...
              },
              {
                ...
                desc: "Descripciones inteligentes y emocionalmente resonantes que impulsan el engagement y las ventas."
              },
              {
                num: "03",
                title: "MOTOR DE CONTENIDO",
                desc: "Material de marketing completo: captions para Instagram, brochures PDF y más."
              },
              {
                num: "04",
                title: "ANALÍTICAS",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-12 text-center md:text-left">
            <div className="flex-1">
              ...
              <p className="text-xs uppercase tracking-widest text-muted-foreground">Listados</p>
            </div>
            <div className="hidden md:block w-px h-16 bg-white/10" />
            <div className="flex-1">
              <p className="text-5xl font-sans font-bold text-white mb-2">Instantáneo</p>
      ...
      <section className="py-32 bg-background relative">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-[#111111] border border-white/10 p-12 md:p-24">
            <h2 className="text-3xl md:text-5xl font-sans font-bold text-white mb-6 uppercase tracking-tight">Hecho para Profesionales</h2>
            <p className="text-muted-foreground leading-relaxed font-light mb-12 max-w-xl mx-auto">
              Únete a la nueva ola del marketing inmobiliario. Optimiza tu flujo de trabajo y crea experiencias de propiedad inolvidables.
            </p>
            <Link
              href="/nuevo-listado"
